...
import { ArrowLeft, User, Mail, Lock, Shield, Phone, Building } from "lucide-react";
import { updateStaff } from "../../api/manager";
...
export default function EditStaff({ onBack, staff }: EditStaffProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        // Check if formData is exactly the same as staff
        if (JSON.stringify(formData) === JSON.stringify(staff)) {
            alert("Please change at least one field to edit the staff member.");
    ...
    return (
        <div className="flex flex-col gap-6 w-full">
            ...
            <div className="flex flex-col">
                ...
                <p className="text-slate-400">Update staff information</p>
            </div>
                                        ...
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                ...
                                                <div className="flex items-center gap-2 mt-1">
                                                    <span
                                                        className={`text-xs px-2 py-1 rounded-full ${formData.isActive
