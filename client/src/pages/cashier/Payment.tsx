...
import { CreditCard, Wallet, Banknote, QrCode, ArrowLeft, CheckCircle, Clock, Sofa, Monitor, Receipt, User, Calendar, MapPin } from "lucide-react";
                            ...
                            <div className="bg-gray-800/50 rounded-xl p-6 text-left">
                                ...
                                <div className="space-y-2 text-sm">
                                    ...
                                    <div className="flex justify-between">
                                        ...
                                        <span>{bookingSummary.date} at {bookingSummary.time}</span>
                                    </div>
                                    <div className="flex justify-between">
                            ...
                            <div className="bg-gray-700/50 rounded-lg p-4">
                                ...
                                <div className="space-y-2 text-sm">
                                    <div className="flex justify-between">
                                        ...
                                        <span className="font-medium">{bookingSummary.seats.join(", ")}</span>
                                    </div>
                                    <div className="flex justify-between">
                    ...
                    <div className="bg-gray-800/50 rounded-xl p-6 border border-gray-700">
                        ...
                        <div className="space-y-3">
                            {bookingSummary.seats.map((seat) => (
                                <div key={seat} className="flex justify-between items-center py-2 border-b border-gray-700 last:border-b-0">
                            ...
                            <div className="border-t border-gray-600 pt-4 mt-4">
                                <div className="flex justify-between items-center">
                                    ...
                                    <span className="text-2xl font-bold text-green-400">${bookingSummary.totalAmount}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div className="space-y-3">
                                <div className="flex flex-col gap-2 ">
                                    <div className="flex gap-4 border border-gray-700 rounded-lg p-4 items-center">
                                        <div className="bg-sky-800 rounded-lg p-1"><CreditCard className="w-10 h-10" /></div>
                                        <p>Apple Pay</p>
                                    </div>
                                    <div className="flex  gap-4 border border-gray-700 rounded-lg p-4 items-center">
                                        <div className="bg-sky-800 rounded-lg p-1"><CreditCard className="w-10 h-10" /></div>
