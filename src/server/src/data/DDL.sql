...
-- -- Table theaters (added cinema_id)
...
--   created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
--   updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
--   CONSTRAINT uq_seats UNIQUE (theater_id, row_number, seat_number),
...
--   created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
--   updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
--   CONSTRAINT uq_screenings UNIQUE (theater_id, screening_date, screening_time),
...
--   CONSTRAINT fk_bookings_staff FOREIGN KEY (created_by_staff_id) REFERENCES staff(id)
-- );
...
--   created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
--   CONSTRAINT uq_tickets UNIQUE (booking_id, seat_id),
