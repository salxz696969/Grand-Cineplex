...
export default function Auth() {
    ...
    const handleLogin = async (e: FormEvent<HTMLFormElement>) => {
        ...
        try {
            const res = await TokenAPI.TokenAPICashier.post("/login", {
                email,
                password,
            });
            ...
            setToken(token);
            TokenAPI.TokenAPICashier.defaults.headers.common["Authorization"] = `Bearer ${token}`;
            ...
            console.log("Auth: Login successful, navigating to /cashier");
            navigate("/cashier");
        } catch (err: any) {
        ...
        <div className="min-h-screen bg-gray-950 flex items-center justify-center p-4">
            <div className="w-full max-w-md">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-gray-400 text-sm">Cashier Portal</p>
                </div>
