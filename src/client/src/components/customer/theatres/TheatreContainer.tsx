...
export default function TheatreContainer({ screenings, movieId }: Props) {
  ...
  return (
    <div className="flex flex-col gap-4 w-full  border-gray-700 lg:pl-4 py-4">
      ...
      <div className="space-y-4 lg:max-h-[600px] lg:overflow-y-auto  lg:scrollbar-thin lg:scrollbar-thumb-sky-500 lg:scrollbar-track-gray-800">
